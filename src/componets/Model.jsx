  ...
  return (
    <section className="common-padding">
      <div className="screen-max-width">
        <h1 id="heading" className="section-heading text-zinc-400">
          Take a closer look
        </h1>
        ...
        <div className="flex flex-col items-center mt-5">
          ...
          <div className="mx-auto w-full">
            <p className=" text-lg text-center relative bottom-9">{model.title}</p>

            <div className="flex justify-center items-center gap-2.5">
              <ul  className="color-container flex justify-center items-center">
                {models.map((item, i) => (
